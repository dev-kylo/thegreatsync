  ...
  return (
    ...
    >
      <Container className="text-lg tracking-tight text-slate-700">
        ...
        <p className="mt-4">
          Do these words sound familiar? Maybe there's a voice in your head telling you things like:
        </p>
        ...
        <p className="mt-8 font-bold">That last one is HAUNTING for me. Because I felt once..</p>
        <p className="mt-4">
        ...
        <p className="mt-4"> As a senior JavaScript developer who has coached and mentored beginners and juniors for YEARS, I can tell you with certainty you are capable - YOU CAN DO THIS. </p>
