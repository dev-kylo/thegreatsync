...
const sections = [
  {
    ...
    title: (
      <>
        <span className="hidden lg:inline">The Method</span>
        <span className="lg:hidden">Contents</span>
      </>
    ),
  },
  { id: 'screencasts', title: 'The Fundamentals' },
  { id: 'author', title: 'The Model' },
  { id: 'resources', title: 'Your WHY' },
  { id: 'pricing', title: "Buy Now" },
]
