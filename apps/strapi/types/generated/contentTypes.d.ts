...
export interface PluginUsersPermissionsUser extends Schema.CollectionType {
  ...
  attributes: {
    ...
    orders: Attribute.Relation<
      ...
      'api::order.order'
    >;
    user_course_progresses: Attribute.Relation<
      'plugin::users-permissions.user',
      'oneToMany',
...
export interface ApiChapterChapter extends Schema.CollectionType {
  ...
  attributes: {
    ...
    subchapters: Attribute.Relation<
      'api::chapter.chapter',
      'oneToMany',
...
export interface ApiSubchapterSubchapter extends Schema.CollectionType {
  ...
  attributes: {
    ...
    pages: Attribute.Relation<
      ...
      'api::page.page'
    >;
    menu: Attribute.Component<'menu.menu-info'> & Attribute.Required;
    visible: Attribute.Boolean & Attribute.DefaultTo<true>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
...
export interface ApiUserCourseProgressUserCourseProgress
  ...
  attributes: {
    ...
    course: Attribute.Relation<
      ...
      'api::course.course'
    >;
    chapters: Attribute.JSON;
    subchapters: Attribute.JSON;
