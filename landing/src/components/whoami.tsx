          ...
          <figure className="grid grid-cols-1 items-center gap-x-6  lg:gap-x-10">
            <div className="relative col-span-2 lg:col-start-1 lg:row-start-2">
              <blockquote className="text-lg font-semibold leading-6 text-gray-900 sm:text-2xl sm:leading-8 mb-4">
                ...
                <p>
                  I don&lsquo;t have a background in computer science. I studied media... But it turns out it&lsquo;s not an in depth knowledge of computers you need. It&lsquo;s your creativity!
                </p>
              </blockquote>
            </div>
