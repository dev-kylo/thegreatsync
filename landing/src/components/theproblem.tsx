    ...
    <div className="relative isolate overflow-hidden bg-white py-12 sm:py-24 ">
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl lg:mx-0">
          ...
          <p className="mt-6 text-xl leading-8 text-gray-700">
          It was one of the most frustrating periods. In the beginning, I was on a high after learning CSS. Finally I could see code transform a blank page into a beautiful design. 
          </p>
          {/* <p className="mt-6 text-xl leading-8 text-gray-700">
        ...
        <div className="mx-auto mt-16 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:mx-0 lg:mt-0 lg:max-w-none lg:grid-cols-12">
          ...
          <div className="max-w-xl text-base leading-7 text-gray-700 lg:col-span-7">
            ...
            <p className="mt-6 text-xl leading-8 text-gray-700">
            Sadly, the truth was I had NO idea what I was doing. 
            </p>
            <p className="mt-6 text-xl leading-8 text-gray-700">
            All the excitement of learning web development was soon replaced by day-to-day frustration and overwhelming imposter syndrome.
            </p>
          </div>
        </div>
      </div>
